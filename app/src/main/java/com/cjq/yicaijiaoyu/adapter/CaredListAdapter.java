 ...
 */
public class CaredListAdapter extends BaseAdapter {
    List<Cared> courses;
    Context context;
    ...
    public List<Cared> getCourses() {
        return courses;
    }

    public void setCourses(List<Cared> courses) {
        this.courses = courses;
    }

    public CaredListAdapter(List<Cared> courses, Context context) {
        this.courses = courses;
        this.context = context;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Cared entity = courses.get(position);
        if(showFree)
