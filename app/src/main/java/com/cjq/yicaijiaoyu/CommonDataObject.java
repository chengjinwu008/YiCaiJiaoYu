...
public class CommonDataObject {
    ...
    public final static String POLYV_INIT_URL ="";//视频播放器初始化请求地址 请求json的地方
    ...
    public static final String FORGET_SMS_URL = "/service/app.php";//忘记密码短信验证码请求接口
    public static final String RESET_PASSWORD_URL = "/service/app.php";//重置密码请求接口
