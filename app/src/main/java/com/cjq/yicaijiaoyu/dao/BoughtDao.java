...
/** 
 * DAO for table BOUGHT.
*/
public class BoughtDao extends AbstractDao<Bought, Long> {

    public static final String TABLENAME = "BOUGHT";

    /**
     * Properties of entity Bought.<br/>
    ...
    */
    ...
    public BoughtDao(DaoConfig config) {
        super(config);
    }
    
    public BoughtDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'BOUGHT' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'BOUGHT'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, Bought entity) {
        stmt.clearBindings();
    ...
    @Override
    protected void attachEntity(Bought entity) {
    ...
    /** @inheritdoc */
    @Override
    public Bought readEntity(Cursor cursor, int offset) {
        Bought entity = new Bought( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, Bought entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(Bought entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(Bought entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
